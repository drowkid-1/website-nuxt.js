...
import _sfc_main$1 from "./index-618e2ce1.js";
...
import { p as parseMenuTitle, a as parseMenuRoute } from "./navbar-325d58c0.js";
            ...
            _push2(ssrRenderComponent(_component_LayoutPageSection, { class: "flex-1 flex" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<!--]--></h1><div class="px-4 mt-6 text-center max-w-[500px] md:max-w-[600px]"${_scopeId2}>${ssrInterpolate(((_a2 = unref(awesome)) == null ? void 0 : _a2.description) || "Todos mis proyectos de código abierto los encontrarás aquí.")}</div>`);
                  if (unref(showAlert)) {
                  ...
                  return [
                    createVNode("div", { class: "flex-1 flex flex-col items-center justify-center" }, [
                      ...
                      createVNode("div", { class: "px-4 mt-6 text-center max-w-[500px] md:max-w-[600px]" }, toDisplayString(((_B = unref(awesome)) == null ? void 0 : _B.description) || "Todos mis proyectos de código abierto los encontrarás aquí."), 1),
                ...
                default: withCtx(() => {
                  ...
                  return [
                    createVNode("div", { class: "flex-1 flex flex-col items-center justify-center" }, [
                      ...
                      createVNode("div", { class: "px-4 mt-6 text-center max-w-[500px] md:max-w-[600px]" }, toDisplayString(((_a2 = unref(awesome)) == null ? void 0 : _a2.description) || "Todos mis proyectos de código abierto los encontrarás aquí."), 1),
                      unref(showAlert) ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "mt-4 w-auto text-center text-white bg-gray-800 rounded px-4 py-1 text-sm"
                      }, ' create file "~/pages/index.vue" to replace this page ')) : createCommentVNode("", true),
...
//# sourceMappingURL=Welcome-97f0f892.js.map
