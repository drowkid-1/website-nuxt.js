  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--4d0fd13e": iconUrl.value
      } };
      _push(`<span${ssrRenderAttrs(mergeProps({
        style: { width: sSize.value, height: sSize.value }
      }, _attrs, _cssVars))} data-v-e5420e98></span>`);
    };
  }
});
const IconCSS_vue_vue_type_style_index_0_scoped_e5420e98_lang = "";
...
const IconCSS = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e5420e98"]]);
export {
  IconCSS as default
};
//# sourceMappingURL=IconCSS-b733f050.js.map
