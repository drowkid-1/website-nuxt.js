import { hasInjectionContext, getCurrentInstance, reactive, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, effectScope, ref, markRaw, toRaw, watch, unref, isReactive, getCurrentScope, onScopeDispose, toRefs, version, watchEffect, isShallow, defineAsyncComponent, defineComponent, h, Suspense, mergeProps, Transition, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/document-driven-c420ba1c.js").then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-d1c7f23f.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/blank-ca64a22a.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/components-2017d738.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/setting-ec00dbf6.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/test-e866a22f.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-c88fe2e0.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_slug_-0e6ac693.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-6ab16089.js").then((m) => m.default || m)
  }
];
...
const LazyLayoutPageContent = defineAsyncComponent(() => import("./_nuxt/Content-98cfa635.js").then((r) => r.default));
const LazyLayoutPageFooter = defineAsyncComponent(() => import("./_nuxt/Footer-c69c6d7b.js").then((r) => r.default));
const LazyLayoutPageHeader = defineAsyncComponent(() => import("./_nuxt/Header-e98b6953.js").then((r) => r.default));
const LazyLayoutPageNavbar = defineAsyncComponent(() => import("./_nuxt/Navbar-da3708d3.js").then((r) => r.default));
const LazyLayoutPageNavbarDropdownThemeSwitcher = defineAsyncComponent(() => import("./_nuxt/ThemeSwitcher-6d827a6d.js").then((r) => r.default));
const LazyLayoutPageNavbarMenuItem = defineAsyncComponent(() => import("./_nuxt/Item-e6cc376d.js").then((r) => r.default));
const LazyLayoutPageNavbarMenuWrapper = defineAsyncComponent(() => import("./_nuxt/Wrapper-d98d1e7a.js").then((r) => r.default));
const LazyLayoutPageSectionTitle = defineAsyncComponent(() => import("./_nuxt/Title-6c285d92.js").then((r) => r.default));
const LazyLayoutPageSection = defineAsyncComponent(() => import("./_nuxt/index-f9fcc53e.js").then((r) => r.default));
const LazyLayoutPageTitle = defineAsyncComponent(() => import("./_nuxt/Title-5388c357.js").then((r) => r.default));
const LazyLayoutPageWrapper = defineAsyncComponent(() => import("./_nuxt/Wrapper-a22f4fc5.js").then((r) => r.default));
const LazyAwesomeActionSheetGroup = defineAsyncComponent(() => import("./_nuxt/Group-d2f5b2d7.js").then((r) => r.default));
const LazyAwesomeActionSheetHeader = defineAsyncComponent(() => import("./_nuxt/Header-8d5b387c.js").then((r) => r.default));
const LazyAwesomeActionSheetHeaderMessage = defineAsyncComponent(() => import("./_nuxt/HeaderMessage-7a0c41b1.js").then((r) => r.default));
const LazyAwesomeActionSheetHeaderTitle = defineAsyncComponent(() => import("./_nuxt/HeaderTitle-d6e7dd6a.js").then((r) => r.default));
const LazyAwesomeActionSheetItem = defineAsyncComponent(() => import("./_nuxt/Item-46ea880d.js").then((r) => r.default));
const LazyAwesomeActionSheetItemButton = defineAsyncComponent(() => import("./_nuxt/ItemButton-60a1f4cb.js").then((r) => r.default));
const LazyAwesomeActionSheet = defineAsyncComponent(() => import("./_nuxt/index-be73beac.js").then((r) => r.default));
const LazyAwesomeAlertBanner = defineAsyncComponent(() => import("./_nuxt/AlertBanner-4980622e.js").then((r) => r.default));
const LazyAwesomeButton = defineAsyncComponent(() => import("./_nuxt/index-618e2ce1.js").then((r) => r.default));
const LazyAwesomeCardContent = defineAsyncComponent(() => import("./_nuxt/Content-cab42655.js").then((r) => r.default));
const LazyAwesomeCardFooter = defineAsyncComponent(() => import("./_nuxt/Footer-19b816c1.js").then((r) => r.default));
const LazyAwesomeCardTitle = defineAsyncComponent(() => import("./_nuxt/Title-63c77f4c.js").then((r) => r.default));
const LazyAwesomeCard = defineAsyncComponent(() => import("./_nuxt/index-f33559ad.js").then((r) => r.default));
const LazyAwesomeContentDoc = defineAsyncComponent(() => import("./_nuxt/Doc-1322eb9e.js").then((r) => r.default));
const LazyAwesomeContentRenderer = defineAsyncComponent(() => import("./_nuxt/Renderer-981ecd25.js").then((r) => r.default));
const LazyAwesomeError = defineAsyncComponent(() => import("./_nuxt/Error-d2596c2b.js").then((r) => r.default));
const LazyAwesomeFormSwitch = defineAsyncComponent(() => import("./_nuxt/Switch-52f3edb6.js").then((r) => r.default));
const LazyAwesomeFormTextInput = defineAsyncComponent(() => import("./_nuxt/TextInput-2ea03088.js").then((r) => r.default));
const LazyAwesomeLink = defineAsyncComponent(() => import("./_nuxt/index-a3956a74.js").then((r) => r.default));
const LazyAwesomeTab = defineAsyncComponent(() => import("./_nuxt/Tab-91d9208b.js").then((r) => r.default));
const LazyAwesomeTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-453f41df.js").then((r) => r.default));
const LazyAwesomeWelcome = defineAsyncComponent(() => import("./_nuxt/Welcome-97f0f892.js").then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-18fa7b27.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-bf854455.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-e14f7eff.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-7bee636d.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-973732d0.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-8446f29b.js").then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-3d305437.js").then((r) => r.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenEmpty-5888371d.js").then((r) => r.default));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenNotFound-0677fb63.js").then((r) => r.default));
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-80e9780b.js").then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-00366c8e.js").then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-a121e0fe.js").then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-01a0c485.js").then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-09a7de42.js").then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-bbf968fd.js").then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-1cea6ac1.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-6b9f73ec.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-c6d4985e.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-fbdee624.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-a04d84c0.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-1b865025.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-976f89dd.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-715e68f8.js").then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-cd931099.js").then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-f74a8ae4.js").then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-8ed6de0e.js").then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-5a6f308f.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-e6b886db.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-61b36c7d.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-33b51533.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-552b1858.js").then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-04fe5c7e.js").then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-9a6e8da6.js").then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-65efdc57.js").then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-f76e60ed.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-b733f050.js").then((r) => r.default));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./_nuxt/client-db-485a9c69.js").then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./_nuxt/client-db-485a9c69.js").then((m) => m.generateNavigation);
...
const layouts = {
  page: /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/page-0a6ce86c.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-14de1e8e.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-eae4fe1c.js").then((r) => r.default || r));
