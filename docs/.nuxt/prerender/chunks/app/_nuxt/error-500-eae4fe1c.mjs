...
import { mergeProps, useSSRContext } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-35000bea><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-35000bea></div><div class="max-w-520px text-center" data-v-35000bea><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-35000bea>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-35000bea>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35000bea"]]);

export { error500 as default };
//# sourceMappingURL=error-500-eae4fe1c.mjs.map
