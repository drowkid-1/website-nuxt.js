import { ref, onMounted, watchEffect, defineComponent } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { c as c$1, o as o$1, u, H as H$1 } from './env-f8cf6da3.mjs';
...
function w(e, r2 = 0) {
  var t;
  return e === ((t = m(e)) == null ? void 0 : t.body) ? false : u(r2, { [0]() {
    return e.matches(c);
  }, [1]() {
    let l = e;
    for (; l !== null; ) {
...
export { E, N, O, P, T, a, b, f, h, m, o, w };
//# sourceMappingURL=hidden-940c75ed.mjs.map
