import __nuxt_component_0 from './Wrapper-a22f4fc5.mjs';
import __nuxt_component_3 from './index-f9fcc53e.mjs';
import _sfc_main$1 from './index-618e2ce1.mjs';
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { e as useAppConfig } from '../server.mjs';
import { p as parseMenuTitle, a as parseMenuRoute } from './navbar-325d58c0.mjs';
import { ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrInterpolate } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const titlesText = computed(
      () => {
        var _a2, _b2;
        return (((_b2 = (_a2 = awesome == null ? void 0 : awesome.layout) == null ? void 0 : _a2.welcome) == null ? void 0 : _b2.title) || (awesome == null ? void 0 : awesome.name) || "DrowKid&nbsp;3 Content Starter").replaceAll("&nbsp;", "[space]").split(" ").map((item) => item.replaceAll("[space]", " "));
      }
    );
            ...
            _push2(ssrRenderComponent(_component_LayoutPageSection, { class: "flex-1 flex" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<!--]--></h1><div class="px-4 mt-6 text-center max-w-[500px] md:max-w-[600px]"${_scopeId2}>${ssrInterpolate(((_a2 = unref(awesome)) == null ? void 0 : _a2.description) || "Todos mis proyectos de c\xF3digo abierto los encontrar\xE1s aqu\xED.")}</div>`);
                  if (unref(showAlert)) {
                  ...
                  _push3(ssrRenderComponent(_component_AwesomeButton, {
                    ...
                    text: ("parseMenuTitle" in _ctx ? _ctx.parseMenuTitle : unref(parseMenuTitle))(
                      ((_e = (_d2 = (_c2 = (_b2 = unref(awesome)) == null ? void 0 : _b2.layout) == null ? void 0 : _c2.welcome) == null ? void 0 : _d2.primaryActionButton) == null ? void 0 : _e.title) || "Bienvenidxs"
                    ),
                    to: ("parseMenuRoute" in _ctx ? _ctx.parseMenuRoute : unref(parseMenuRoute))(
                      ((_i = (_h = (_g = (_f = unref(awesome)) == null ? void 0 : _f.layout) == null ? void 0 : _g.welcome) == null ? void 0 : _h.primaryActionButton) == null ? void 0 : _i.to) || "https://github.com/drowkid-1"
                    ),
                  ...
                  return [
                    createVNode("div", { class: "flex-1 flex flex-col items-center justify-center" }, [
                      ...
                      createVNode("div", { class: "px-4 mt-6 text-center max-w-[500px] md:max-w-[600px]" }, toDisplayString(((_B = unref(awesome)) == null ? void 0 : _B.description) || "Todos mis proyectos de c\xF3digo abierto los encontrar\xE1s aqu\xED."), 1),
                      ...
                      createVNode("div", { class: "flex space-x-4 ml-2 mt-8 justify-center md:justify-start" }, [
                        createVNode(_component_AwesomeButton, {
                          size: "lg",
                          text: ("parseMenuTitle" in _ctx ? _ctx.parseMenuTitle : unref(parseMenuTitle))(
                            ((_F = (_E = (_D = (_C = unref(awesome)) == null ? void 0 : _C.layout) == null ? void 0 : _D.welcome) == null ? void 0 : _E.primaryActionButton) == null ? void 0 : _F.title) || "Bienvenidxs"
                          ),
                          to: ("parseMenuRoute" in _ctx ? _ctx.parseMenuRoute : unref(parseMenuRoute))(
                            ((_J = (_I = (_H = (_G = unref(awesome)) == null ? void 0 : _G.layout) == null ? void 0 : _H.welcome) == null ? void 0 : _I.primaryActionButton) == null ? void 0 : _J.to) || "https://github.com/drowkid-1"
                          ),
                          class: "font-extrabold"
                        }, null, 8, ["text", "to"]),
                ...
                default: withCtx(() => {
                  ...
                  return [
                    createVNode("div", { class: "flex-1 flex flex-col items-center justify-center" }, [
                      ...
                      createVNode("div", { class: "px-4 mt-6 text-center max-w-[500px] md:max-w-[600px]" }, toDisplayString(((_a2 = unref(awesome)) == null ? void 0 : _a2.description) || "Todos mis proyectos de c\xF3digo abierto los encontrar\xE1s aqu\xED."), 1),
                      unref(showAlert) ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "mt-4 w-auto text-center text-white bg-gray-800 rounded px-4 py-1 text-sm"
                      }, ' create file "~/pages/index.vue" to replace this page ')) : createCommentVNode("", true),
...
//# sourceMappingURL=Welcome-97f0f892.mjs.map
