import { hasInjectionContext, getCurrentInstance, toRef, isRef, inject, version, defineAsyncComponent, computed, defineComponent, unref, ref, useSSRContext, watchEffect, watch, h, Suspense, nextTick, mergeProps, Transition, provide, withCtx, createVNode, createApp, reactive, markRaw, effectScope, isReactive, toRaw, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, toRefs, isShallow } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/ofetch@1.1.1/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/unctx@2.3.1/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue-router@4.2.4_vue@3.3.4/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode, setCookie, getCookie, deleteCookie } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/h3@1.7.1/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, joinURL, withoutTrailingSlash, withLeadingSlash, withBase } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/ufo@1.1.2/node_modules/ufo/dist/index.mjs';
...
import { renderSSRHead } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/@unhead+ssr@1.1.30/node_modules/@unhead/ssr/dist/index.mjs';
import { composableNames, getActiveHead, createServerHead as createServerHead$1 } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/unhead@1.1.30/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/@unhead+shared@1.1.30/node_modules/@unhead/shared/dist/index.mjs';
import { hash, isEqual } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/ohash@1.1.2/node_modules/ohash/dist/index.mjs';
import { parse } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/cookie-es@1.0.0/node_modules/cookie-es/dist/index.mjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///data/data/com.termux/files/home/nuxt3-awesome/node_modules/.pnpm/defu@6.1.2/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/document-driven-c420ba1c.mjs').then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-d1c7f23f.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/blank-ca64a22a.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/components-2017d738.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.name) ?? "setting",
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/setting",
    meta: __nuxt_page_meta$4 || {},
    alias: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.alias) || [],
    redirect: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.redirect) || void 0,
    component: () => import('./_nuxt/setting-ec00dbf6.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "test",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/test",
    meta: __nuxt_page_meta$3 || {},
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/test-e866a22f.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-c88fe2e0.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/_slug_-0e6ac693.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-6ab16089.mjs').then((m) => m.default || m)
  }
];
...
const cfg1 = defineAppConfig({
  awesome: {
    name: "DrowKid Web",
    description: "Aquí encontrarás un breve resumen de cada uno de mis proyectos de código abierto. ",
    project: {
      links: {
...
const revive_payload_server_ucWvl5czqa = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyLayoutPageContent = defineAsyncComponent(() => import('./_nuxt/Content-98cfa635.mjs').then((r) => r.default));
const LazyLayoutPageFooter = defineAsyncComponent(() => import('./_nuxt/Footer-c69c6d7b.mjs').then((r) => r.default));
const LazyLayoutPageHeader = defineAsyncComponent(() => import('./_nuxt/Header-e98b6953.mjs').then((r) => r.default));
const LazyLayoutPageNavbar = defineAsyncComponent(() => import('./_nuxt/Navbar-da3708d3.mjs').then((r) => r.default));
const LazyLayoutPageNavbarDropdownThemeSwitcher = defineAsyncComponent(() => import('./_nuxt/ThemeSwitcher-6d827a6d.mjs').then((r) => r.default));
const LazyLayoutPageNavbarMenuItem = defineAsyncComponent(() => import('./_nuxt/Item-e6cc376d.mjs').then((r) => r.default));
const LazyLayoutPageNavbarMenuWrapper = defineAsyncComponent(() => import('./_nuxt/Wrapper-d98d1e7a.mjs').then((r) => r.default));
const LazyLayoutPageSectionTitle = defineAsyncComponent(() => import('./_nuxt/Title-6c285d92.mjs').then((r) => r.default));
const LazyLayoutPageSection = defineAsyncComponent(() => import('./_nuxt/index-f9fcc53e.mjs').then((r) => r.default));
const LazyLayoutPageTitle = defineAsyncComponent(() => import('./_nuxt/Title-5388c357.mjs').then((r) => r.default));
const LazyLayoutPageWrapper = defineAsyncComponent(() => import('./_nuxt/Wrapper-a22f4fc5.mjs').then((r) => r.default));
const LazyAwesomeActionSheetGroup = defineAsyncComponent(() => import('./_nuxt/Group-d2f5b2d7.mjs').then((r) => r.default));
const LazyAwesomeActionSheetHeader = defineAsyncComponent(() => import('./_nuxt/Header-8d5b387c.mjs').then((r) => r.default));
const LazyAwesomeActionSheetHeaderMessage = defineAsyncComponent(() => import('./_nuxt/HeaderMessage-7a0c41b1.mjs').then((r) => r.default));
const LazyAwesomeActionSheetHeaderTitle = defineAsyncComponent(() => import('./_nuxt/HeaderTitle-d6e7dd6a.mjs').then((r) => r.default));
const LazyAwesomeActionSheetItem = defineAsyncComponent(() => import('./_nuxt/Item-46ea880d.mjs').then((r) => r.default));
const LazyAwesomeActionSheetItemButton = defineAsyncComponent(() => import('./_nuxt/ItemButton-60a1f4cb.mjs').then((r) => r.default));
const LazyAwesomeActionSheet = defineAsyncComponent(() => import('./_nuxt/index-be73beac.mjs').then((r) => r.default));
const LazyAwesomeAlertBanner = defineAsyncComponent(() => import('./_nuxt/AlertBanner-4980622e.mjs').then((r) => r.default));
const LazyAwesomeButton = defineAsyncComponent(() => import('./_nuxt/index-618e2ce1.mjs').then((r) => r.default));
const LazyAwesomeCardContent = defineAsyncComponent(() => import('./_nuxt/Content-cab42655.mjs').then((r) => r.default));
const LazyAwesomeCardFooter = defineAsyncComponent(() => import('./_nuxt/Footer-19b816c1.mjs').then((r) => r.default));
const LazyAwesomeCardTitle = defineAsyncComponent(() => import('./_nuxt/Title-63c77f4c.mjs').then((r) => r.default));
const LazyAwesomeCard = defineAsyncComponent(() => import('./_nuxt/index-f33559ad.mjs').then((r) => r.default));
const LazyAwesomeContentDoc = defineAsyncComponent(() => import('./_nuxt/Doc-1322eb9e.mjs').then((r) => r.default));
const LazyAwesomeContentRenderer = defineAsyncComponent(() => import('./_nuxt/Renderer-981ecd25.mjs').then((r) => r.default));
const LazyAwesomeError = defineAsyncComponent(() => import('./_nuxt/Error-d2596c2b.mjs').then((r) => r.default));
const LazyAwesomeFormSwitch = defineAsyncComponent(() => import('./_nuxt/Switch-52f3edb6.mjs').then((r) => r.default));
const LazyAwesomeFormTextInput = defineAsyncComponent(() => import('./_nuxt/TextInput-2ea03088.mjs').then((r) => r.default));
const LazyAwesomeLink = defineAsyncComponent(() => import('./_nuxt/index-a3956a74.mjs').then((r) => r.default));
const LazyAwesomeTab = defineAsyncComponent(() => import('./_nuxt/Tab-91d9208b.mjs').then((r) => r.default));
const LazyAwesomeTabs = defineAsyncComponent(() => import('./_nuxt/Tabs-453f41df.mjs').then((r) => r.default));
const LazyAwesomeWelcome = defineAsyncComponent(() => import('./_nuxt/Welcome-97f0f892.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-18fa7b27.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-bf854455.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-e14f7eff.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-7bee636d.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-973732d0.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-8446f29b.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./_nuxt/ContentSlot-3d305437.mjs').then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import('./_nuxt/Markdown-80e9780b.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-00366c8e.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-a121e0fe.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./_nuxt/ProseCode-01a0c485.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-09a7de42.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-bbf968fd.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-1cea6ac1.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-6b9f73ec.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-c6d4985e.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-fbdee624.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-a04d84c0.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-1b865025.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-976f89dd.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-715e68f8.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-cd931099.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-f74a8ae4.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-8ed6de0e.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-5a6f308f.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-e6b886db.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-61b36c7d.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-33b51533.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-552b1858.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-04fe5c7e.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-9a6e8da6.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-65efdc57.mjs').then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-f76e60ed.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-b733f050.mjs').then((r) => r.default));
...
const unhead_SKF7cFpUjz = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./_nuxt/client-db-485a9c69.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./_nuxt/client-db-485a9c69.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  page: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/page-0a6ce86c.mjs').then((m) => m.default || m))
};
const documentDriven_bOYDOwG0qm = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
  var _a, _b, _c, _d;
...
const plugin_server_iWBuuknfzF = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  plugin$1,
  plugin,
  revive_payload_server_ucWvl5czqa,
  components_plugin_KR1HBZs4kY,
  unhead_SKF7cFpUjz,
  documentDriven_bOYDOwG0qm,
  plugin_server_iWBuuknfzF,
  awesome_kbxNWw0ZAQ
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-14de1e8e.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-eae4fe1c.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.6.1_@types+node@18.0.0_eslint@8.43.0_sass@1.63.4_typescript@5.1.3_vue-tsc@1.8.1/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.6.1_@types+node@18.0.0_eslint@8.43.0_sass@1.63.4_typescript@5.1.3_vue-tsc@1.8.1/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { __nuxt_component_0 as _, useContent as a, useRequestEvent as b, createError as c, defineStore as d, entry$1 as default, useAppConfig as e, useRouter as f, useRoute as g, useRuntimeConfig as h, useContentPreview as i, useState as j, useNuxtApp as k, abortNavigation as l, fetchContentNavigation as m, navigateTo as n, useUnwrap as o, get as p, queryContent as q, assertArray as r, ensureArray as s, sortList as t, useHead as u, apply as v, withoutKeys as w, withKeys as x, createQuery as y };
