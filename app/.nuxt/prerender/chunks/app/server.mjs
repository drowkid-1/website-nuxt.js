...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./_nuxt/index-663fb24a.mjs').then((m) => m.default || m)
  },
  {
...
const LazyAwesomeWelcome = defineAsyncComponent(() => import('./_nuxt/Welcome-4ffbab28.mjs').then((r) => r.default));
